...
namespace Platformer.Model
{
    ...
    public class PlatformerModel
    {
        ...
        public void SetParameters(Cinemachine.CinemachineVirtualCamera camera, PlayerController playerController, Transform spawnTransform)
        {
            this.virtualCamera = camera;
            this.player = playerController;
            this.spawnPoint = spawnTransform;
            camera.LookAt = player.GetComponent<Transform>();
